...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'telephone'           => 'الهاتف',
        'duree_prolongement_jugement'   =>'طلب التمديد',
        'date_declaration'  =>'بيان اخباري',
         'date_repanse_convocation'  =>'ت.ج.البيان الاخباري',
        'date_seance'  =>'ت.الجلسة',
        'nom_defendeur'=>'الاسم',
        'adresse_defendeur'=>'العنوان',
        'nom_avocat.*'=>'اسم المحامي',
        'adresse_avocat.*'=>'عنوان المحامي',
        'ville_avocat.*'=>'المدينة',
       'nom_procureur'=>'الاسم',
        'adresse_procureur'=>'العنوان',
        'num_immobilier'=>'الرسم العقاري',
        'designation_immobilier'=>'اسم العقار',
        'adresse_immobilier'=>'العنوان',
        'ville_immobilier'=>'المدينة',
        'surface'=>'المساحة',
        'genre'=>'ذكرأوأنثى',
        'description_autre'=>'الاطراف الأخرى',
        'adresse_avocat'=>'العنوان',
        'ville_avocat'=>'المدينة',
        'nom_avocat'=>'الاسم',
